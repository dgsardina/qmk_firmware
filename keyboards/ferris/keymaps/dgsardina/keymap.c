 ...
 */
  ...
  //|----------+----------+----------+----------+----------|  |----------+----------+----------+----------+----------|
  //|    ¡     |     <    |     {    |     }    |          |  |    `     |          |    ú     |    ü     |    ¿     |
       ES_IEXL ,  ES_LABK ,  ES_LCBR ,  ES_RCBR ,  _______ ,     ES_GRV  ,  _______ ,  _______ ,  _______ ,  ES_IQUE ,
  //|----------+----------+----------+----------+----------|  |----------+----------+----------+----------+----------|
  //|    á     |     >    |     (    |     )    |          |  |          |    ñ     |    é     |    í     |    ó     |
       _______ ,  ES_RABK ,  ES_LPRN ,  ES_RPRN ,  _______ ,     _______ ,  _______ ,  _______ ,  _______ ,  _______ ,
  //|----------+----------+----------+----------+----------|  |----------+----------+----------+----------+----------|
  //|          |          |     [    |     ]    |          |  |          |          |    €     |          |          |
       _______ ,  _______ ,  ES_LBRC ,  ES_RBRC ,  _______ ,     _______ ,  _______ ,  ES_EUR  ,  _______ ,  _______ ,
  //|----------+----------+----------+----------+----------|  |----------+----------+----------+----------+----------|
  //                     |----------------+----------------|  |----------------+----------------|
  ...
  //|    F5    |    F6    |    F7    |    F8    |          |  |   Mute   |   Shift  |   Ctrl   |    Alt   |    GUI   |
        KC_F5  ,   KC_F6  ,   KC_F7 ,    KC_F8  ,  _______ ,     KC_MUTE ,  KC_RSFT ,  KC_RCTL ,  KC_LALT ,  KC_RGUI ,
  //|----------+----------+----------+----------+----------|  |----------+----------+----------+----------+----------|
  //|    F1    |    F2    |    F3    |    F4    |          |  |Bootloader|   Vol-   |   Vol+  |  Insert  |   PrtSc  |
        KC_F1  ,   KC_F2  ,   KC_F3 ,    KC_F4  ,  _______ ,     QK_BOOT ,  KC_VOLD ,  KC_VOLU ,  KC_INS  ,  KC_PSCR ,
  //|----------+----------+----------+----------+----------|  |----------+----------+----------+----------+----------|
  //                     |----------------+----------------|  |----------------+----------------|
  //                     |                |                |  |                |                |
                               _______    ,     _______    ,         _______   ,     _______
