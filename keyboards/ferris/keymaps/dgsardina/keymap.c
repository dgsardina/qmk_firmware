 ...
 */
  ...
  //|----------+----------+----------+----------+----------|  |----------+----------+----------+----------+----------|
  //|    ¡     |     <    |     {    |     }    |          |  |    `     |          |    ú     |    ü     |    ¿     |
       ES_IEXL ,  _______ ,  ES_LCBR ,  ES_RCBR ,  _______ ,     ES_GRV  ,  _______ ,  _______ ,  _______ ,  ES_IQUE ,
  //|----------+----------+----------+----------+----------|  |----------+----------+----------+----------+----------|
  //|    á     |     >    |     (    |     )    |          |  |          |    ñ     |    é     |    í     |    ó     |
       _______ ,  _______ ,  ES_LPRN ,  ES_RPRN ,  _______ ,     _______ ,  _______ ,  _______ ,  _______ ,  _______ ,
  //|----------+----------+----------+----------+----------|  |----------+----------+----------+----------+----------|
  //|          |          |     [    |     ]    |          |  |          |          |    €     |          |          |
       _______ ,  _______ ,  ES_LBRC ,  ES_RBRC ,  _______ ,     _______ ,  _______ ,  _______ ,  _______ ,  _______ ,
  //|----------+----------+----------+----------+----------|  |----------+----------+----------+----------+----------|
  //                     |----------------+----------------|  |----------------+----------------|
